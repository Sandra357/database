...
database_project: main.o database.o date.o node.o condition_parser.o token.o condition_parser_test.o
	g++ -std=c++17 -o database main.o database.o date.o node.o condition_parser.o token.o \
